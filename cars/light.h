...
class Light {
    ...
    void buffer(World& world, bool yellow = false) {
        // update border buffer
        ...
        if (yellow) {
            tile->buf.borders[0] = Border::None;
            tile->buf.borders[1] = Border::None;
            tile->buf.borders[2] = Border::None;
            tile->buf.borders[3] = Border::None;
    ...
    void tick(World& world) {
        ...
        if (m_t == 0) {
            ...
            // update border buffer
            buffer(world);
        } else if (m_t < lightYellowTicksLeft) {
            // update border buffer
            buffer(world, true);
        };
    };
