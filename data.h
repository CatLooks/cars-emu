...
// road speed
const bool isBuilding[5] {
    0, 0, 0, 0, 0
};
const bt roadType[5] {
    0, 1, 1, 1, 2
};
const bt roadSpeed[2] {
    255, 191
};
...
const IntRect texRoad = IntRect(8  * 16, 0, 16, 16);
const IntRect texPark = IntRect(9  * 16, 0, 16, 16);
const IntRect texDirt = IntRect(10 * 16, 0, 16, 16);
